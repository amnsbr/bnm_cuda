/* 
Includes functions to calculate goodness of fit of a single simulation
...
double check_fit_bold(gsl_matrix * sim_bold, int FCD_step, int FCD_window_size, bool FCD_drop_edges,
    ...
    /* 
        Calculates goodness-of-fit of simulated BOLD to target
        empirical FC and FCD
    */
    ...
    double emp_sim_FC_corr, fcd_ks, fc_diff, cost;
