...
const u_real V_0 = 0.02 * 100; // as %
const u_real ialpha = 1.0/alpha;
const u_real itau = 1.0/tau;
const u_real oneminrho = (1.0 - rho);
#ifdef BW_FRISTON2003
const u_real k1 = 7 * rho;
const u_real k2 = 2.0;
const u_real k3 = 2 * rho - 0.2;
#else // k1, k2 and k3 corresponding to 3T scanner as used in Demirtas 2019
const u_real k1 = 3.72;
const u_real k2 = 0.527;
const u_real k3 = 0.53;
#endif
